...
This repository might include code for data collection, but will prioritize interpreting it and actually assigning fighters with certain elo values.

The primary goal of this project is to properly incorporate an algorithm that properly contextualizes the level of fighters to my best ability.
